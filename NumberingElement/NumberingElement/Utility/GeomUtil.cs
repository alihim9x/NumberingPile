...
namespace Utility
{
    public static class GeomUtil
    {
        ...
        public static double Distance2P(this Autodesk.Revit.DB.XYZ firstP, Autodesk.Revit.DB.XYZ secondP)
        {
            double dis = 0;
            dis = Math.Sqrt(Math.Pow(firstP.X - secondP.X,2) + Math.Pow(firstP.Y - secondP.Y,2)) ;
            return dis;
        }
